...
ovs-vsctl add-port  br_mpls1 udp_port1 -- set interface udp_port1 type=bareudp options:remote_ip=2.1.1.3 options:local_ip=2.1.1.2 options:payload_type=mpls options:dst_port=6635  ofport_request=$bareudp_egress_port
ovs-vsctl add-port  br_mpls2 udp_port2 -- set interface udp_port2 type=bareudp options:remote_ip=2.1.1.2 options:local_ip=2.1.1.3 options:payload_type=mpls  options:dst_port=6635  ofport_request=$bareudp_egress_port
