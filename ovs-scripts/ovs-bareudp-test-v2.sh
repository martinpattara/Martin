...
mpls_multiple_mpls_error_rules () {
...
ovs-ofctl -O OpenFlow13 add-flow br_mpls1 "in_port=$ingress_port,dl_type=0x0800,nw_dst=1.1.1.2 actions=push_mpls:0x8847,push_mpls:0x8847,output:$egress_port"
#ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "in_port=$egress_port,dl_type=0x8847 actions=pop_mpls:0x0800,goto_table:2"
ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "in_port=$egress_port,dl_type=0x8847 actions=goto_table:2"
...
ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "table=1,in_port=$egress_port,dl_type=0x0800,nw_dst=1.1.1.2 actions=set_field:00:00:00:00:00:02->dl_dst,set_field:00:00:00:00:00:01->dl_src output:$ingress_port"
ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "table=2,in_port=$egress_port,dl_type=0x8847 actions=pop_mpls:0x0800,goto_table:3"
ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "table=3,in_port=$egress_port,dl_type=0x0800,nw_dst=1.1.1.2 actions=set_field:00:00:00:00:00:02->dl_dst,set_field:00:00:00:00:00:01->dl_src output:$ingress_port"
}


mpls_multiple_mpls_rules () {
#ovs-ofctl -O OpenFlow13 add-flow br_mpls1 "in_port=$ingress_port,dl_type=0x0800,nw_dst=1.1.1.2 actions=encap(mpls),set_field:13->mpls_label,encap(ethernet),push_mpls:0x8847,set_field:15->mpls_label,output:$egress_port"
#ovs-ofctl -O OpenFlow13 add-flow br_mpls1 "in_port=$egress_port actions=encap(mpls),output:$ingress_port"
#ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "in_port=$ingress_port actions=encap(mpls),output:$egress_port"
#ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "in_port=$egress_port actions=encap(mpls),output:$ingress_port"
...
#ovs-ofctl -O OpenFlow13 add-flow br_mpls1 "in_port=$ingress_port,dl_type=0x0800,nw_dst=1.1.1.2 actions=encap(nsh(md_type=1)),output:$egress_port"
ovs-ofctl -O OpenFlow13 add-flow br_mpls1 "in_port=$ingress_port,dl_type=0x0800,nw_dst=1.1.1.2 actions=push_mpls:0x8847,push_mpls:0x8847,output:$egress_port"
ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "in_port=$egress_port,dl_type=0x8847 actions=pop_mpls:0x8847,pop_mpls:0x0800,goto_table:1"
ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "in_port=$egress_port,dl_type=0x0800 actions=goto_table:1"
#ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "table=1,in_port=$egress_port,dl_type=0x0800,nw_dst=1.1.1.2 actions=output:$ingress_port"
ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "table=1,in_port=$egress_port,dl_type=0x0800,nw_dst=1.1.1.2 actions=set_field:00:00:00:00:00:02->dl_dst,set_field:00:00:00:00:00:01->dl_src output:$ingress_port"
}

mpls_multiple_encap_rules () {
#ovs-ofctl -O OpenFlow13 add-flow br_mpls1 "in_port=$ingress_port,dl_type=0x0800,nw_dst=1.1.1.2 actions=encap(mpls),set_field:13->mpls_label,encap(ethernet),push_mpls:0x8847,set_field:15->mpls_label,output:$egress_port"
#ovs-ofctl -O OpenFlow13 add-flow br_mpls1 "in_port=$egress_port actions=encap(mpls),output:$ingress_port"
#ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "in_port=$ingress_port actions=encap(mpls),output:$egress_port"
#ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "in_port=$egress_port actions=encap(mpls),output:$ingress_port"
...
#ovs-ofctl -O OpenFlow13 add-flow br_mpls1 "in_port=$ingress_port,dl_type=0x0800,nw_dst=1.1.1.2 actions=encap(mpls(ether_type=0x8847)),set_field:13->mpls_label,encap(ethernet),push_mpls:0x8847,set_field:15->mpls_label,output:$egress_port"
#ovs-ofctl -O OpenFlow13 add-flow br_mpls1 "in_port=$ingress_port,dl_type=0x0800,nw_dst=1.1.1.2 actions=encap(nsh(md_type=1)),output:$egress_port"
ovs-ofctl -O OpenFlow13 add-flow br_mpls1 "in_port=$ingress_port,dl_type=0x0800,nw_dst=1.1.1.2 actions=encap(mpls(ether_type=0x8847)),encap(mpls(ether_type=0x8847)),encap(ethernet),output:$egress_port"
ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "in_port=$egress_port,dl_type=0x8847 actions=decap(),decap(packet_type(ns=1,type=0x8847)),decap(packet_type(ns=0,type=0),goto_table:1"
ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "in_port=$egress_port,dl_type=0x0800 actions=goto_table:1"
#ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "table=1,in_port=$egress_port,dl_type=0x0800,nw_dst=1.1.1.2 actions=output:$ingress_port"
ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "table=1,in_port=$egress_port,dl_type=0x0800,nw_dst=1.1.1.2 actions=set_field:00:00:00:00:00:02->dl_dst,set_field:00:00:00:00:00:01->dl_src output:$ingress_port"
...
ovs-ofctl -O OpenFlow13 add-flow br_mpls1 "in_port=$ingress_port,dl_type=0x0800 actions=encap(mpls(ether_type=0x8847)),set_field:13->mpls_label,encap(ethernet),output:$bareudp_egress_port"
...
ovs-ofctl -O OpenFlow13 add-flow br_mpls2 "table=1,in_port=$bareudp_egress_port,dl_type=0x0800 actions=output:$ingress_port"
}
